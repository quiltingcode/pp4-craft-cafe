...
from booking.views import ProfilePageView, ContactPage, EditBooking, DeleteBooking, DeleteAccount, StaffView, AdminApproval, AdminEditBooking, AdminDeleteBooking
...
urlpatterns = [
    ...
    path('admin-edit-booking/<int:pk>', AdminEditBooking.as_view(), name='admin-edit-booking'),
    path('profile-page/<int:pk>/delete', DeleteBooking.as_view(), name='delete-booking'),
    path('admin-delete-booking/<int:pk>', AdminDeleteBooking.as_view(), name='admin-delete-booking'),
